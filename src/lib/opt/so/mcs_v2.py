...
class MCSV2(object):
    def __init__(self, args, init, eval_obj, files_man, seed):
        ...
        self.pop_size = args.mcs_pop_size_v2
        self.max_gen = args.mcs_max_gen_v2

        self.checkpoint = args.checkpoint  # saving frequency
        self.n_states = int(self.max_gen / self.checkpoint)  # n updates

        # MCS Parameters
        self.frac_dis = args.frac_dis_v2
        self.constrain = args.constrain_v2
        self.max_step = args.max_step_v2
        self.pwr = args.pwr_v2
        self.flight = args.flight_v2
        self.nests_del = args.nests_del_v2
        self.min_nests = args.min_nests_v2
        ...
        if self.work_out:
            ...
            log_file.write('MCS V2 init - Pop Shape: ')
