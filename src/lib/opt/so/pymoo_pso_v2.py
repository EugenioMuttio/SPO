...
class PymooPSOV2(object):
    def __init__(self, args, init, proj, files_man, seed):
        ...
        """
        # Name
        self.name = 'PymooPSOV2'

        # Problem parameters
        self.n_param = args.n_param

        # Optimiser Parameters
        self.pop_size = args.pso_pop_size_v2
        self.max_gen = args.pso_max_gen_v2
        ...
        # PSO Parameters
        self.w_inertia = args.w_inertia_v2
        self.c1 = args.c1_v2
        self.c2 = args.c2_v2
        self.max_vel_rate = args.max_vel_rate_v2
        self.init_vel = args.init_vel_v2
        self.adapt = args.adapt_v2
