...
class PymooDE(object):
    def __init__(self, args, init, eval_obj, files_man, seed):
        """
        Class object to run a DE optimiser from Pymoo library
        ...
        de_pop_size: Population size
        sampling: sampling technique (i.e LHS)
        variant: selected method
        CR: crossover constant
        F: weighting factor
        NP: number of parents
        dither: a technique that improves convergence
        ...
        # print('DE init - Pop Shape: ', self.pop_init.shape)
        # Devices
        ...
        if self.work_out:
            ...
            log_file.write('DE init - Pop Shape: ')
        ...
        self.algorithm = DE(pop_size=self.pop_size,
    ...
    def run(self):
        ...
        while self.algorithm.has_next():
            ...
            i = 0
            while pop.size < self.pop_size and i < self.pop_size:
