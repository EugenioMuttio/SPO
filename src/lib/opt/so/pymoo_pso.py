...
class PymooPSO(object):
    def __init__(self, args, init, proj, files_man, seed):
        ...
        # PSO Parameters
        self.w_inertia = args.w_inertia
        self.c1 = args.c1
        self.c2 = args.c2
        self.max_vel_rate = args.max_vel_rate
        self.init_vel = args.init_vel
